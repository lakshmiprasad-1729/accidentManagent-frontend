              ...
              <div className="flex gap-2">
                ...
                {!isOtpVerified && (
                  <button
                    ...
                    className={`px-4 py-3  ${isOtpLoading?"bg-blue-400":"bg-blue-600"} text-white rounded-lg hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center gap-2 whitespace-nowrap`}
                  >
                    {isOtpLoading ? (
                      <>
